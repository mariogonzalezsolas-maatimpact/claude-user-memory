...
- **Upgrade**: Performs smart-merge
  ...
  2. Replaces managed section between `# --- AGENTIC SUBSTRATE START ---` and `# --- AGENTIC SUBSTRATE END ---` markers, preserving user content outside the markers. If no markers found, performs full replacement with backup.
