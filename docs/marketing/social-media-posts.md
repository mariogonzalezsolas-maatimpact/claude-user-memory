...
**Agentic Substrate v6.0: Applying Anthropic's Research to Production**
...
The result is Agentic Substrate v6.0 - a system-wide enhancement that implements patterns like extended thinking, context engineering, and multi-agent orchestration.
...
Agentic Substrate v6.0 is a system-wide enhancement for Claude Code CLI. It implements several patterns from Anthropic's research:
